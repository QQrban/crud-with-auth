...
export const Modal = ({ onClose, setRegisterPage }: ModalProps) => {
    const closeModal = () => {
                ...
                <div className="fixed inset-0 p-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto">
                    <div className="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 relative">
                        ...
                        <button
                            ...
                            id="closeButton"
                            type="button"
                            className="cursor-pointer px-5 py-2.5 w-full rounded-lg text-white text-sm font-medium border-none outline-none bg-green-700 hover:bg-green-800"
                        >
                            Got it
                        </button>
                    </div>
